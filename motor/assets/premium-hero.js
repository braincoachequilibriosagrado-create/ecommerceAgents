(function (global) {
  ...
  var FRAG = [
    ...
    'const vec3 cBlueHi = vec3(0.302, 0.561, 1.0);',
    ...
    '    vec3 ray = mix(cBlue, cBlueHi, smoothstep(0.0, 0.55, mixA));',
    '    ray = mix(ray, cWhite, smoothstep(0.55, 1.0, mixA));',
    '    col += ray * line * (0.22 + fi * 0.04);',
    '  }',
    '  col += vec3(0.02, 0.05, 0.12) * smoothstep(0.2, 0.9, uv.y);',
